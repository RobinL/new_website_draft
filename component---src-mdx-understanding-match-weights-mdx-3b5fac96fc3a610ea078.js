"use strict";(self.webpackChunkrobinlinacre=self.webpackChunkrobinlinacre||[]).push([[7640],{7118:function(e,t,a){a.r(t),a.d(t,{Head:function(){return Ka},default:function(){return Va},output_order:function(){return Oa}});var o=a(7294),r=a(7506),n=a(7825);function i(e){return e`# Arquero
...
## Utilities
`}function T(e){const t=e=>`<span style="color: #999;">${e}</span>`;return function(a,o={}){"number"==typeof o&&(o={limit:o});const r={...o.color};if("function"==typeof o.color)a.columnNames().forEach((e=>r[e]=o.color));else for(const e in r){const t=r[e];r[e]="function"==typeof t?t:()=>t}const n=(e,t,a)=>`padding: 1px 5px; white-space: nowrap; overflow-x: hidden; text-overflow: ellipsis; font-variant-numeric: tabular-nums; max-width: ${+o.maxCellWidth||300}px;`+(r[e]?` background-color: ${r[e](t,a)};`:""),i=`max-height: ${+(o={limit:100,null:t,...o,style:{table:"margin: 0; border-collapse: collapse; width: initial;",td:n,th:n}}).height||270}px`,l=e`<div style="${`${i}; overflow-x: auto; overflow-y: auto;`}">${a.toHTML(o)}</div>`;return l.value=a,l}}function P(e,t){const a=e.module();return a.variable(t()).define(["md"],i),a.variable(t()).define(["md"],l),a.variable(t("aq")).define("aq",["require","aq_version","aq_packages","toView"],s),a.variable(t("aq_version")).define("aq_version",m),a.variable(t("aq_packages")).define("aq_packages",c),a.variable(t()).define(["md"],u),a.variable(t("op")).define("op",["aq"],d),a.variable(t()).define(["md"],_),a.variable(t()).define(["md"],f),a.variable(t()).define(["md"],p),a.variable(t()).define(["md"],b),a.variable(t()).define(["md"],h),a.variable(t("dt")).define("dt",["aq"],v),a.variable(t()).define(["md"],g),a.variable(t()).define(["dt","op"],y),a.variable(t()).define(["md"],w),a.variable(t()).define(["dt","op"],x),a.variable(t()).define(["md"],k),a.variable(t()).define(["dt","aq","op"],q),a.variable(t()).define(["md"],$),a.variable(t("toView")).define("toView",["html"],T),a}function F(e){return e`# Record Utilities`}function E(e){return class{constructor(e){this.record_dict=e}as_dict(){return this.record_dict}as_aq(){return e.from([this.record_dict])}display(){return this.as_aq().view()}}}function S(e){return class{constructor(e,t){this.record_l=e,this.record_r=t}as_long(){let t=[this.record_l.as_dict(),this.record_r.as_dict()];return e.from(t)}as_wide(){let e=this.record_l.as_aq(),t=this.record_r.as_aq(),a=e.join(t,((e,t)=>!0),null,{suffix:["_l","_r"]}),o=e.columnNames(),r=[];return o.forEach((e=>{r.push(e+"_l"),r.push(e+"_r")})),a=a.select(r),a}display(e="long"){return"long"==e?this.as_long().view():"wide"==e?this.as_wide().view():void 0}}}function B(e,t){const a=e.module();a.variable(t()).define(["md"],F),a.variable(t("Record")).define("Record",["aq"],E),a.variable(t("RecordComparison")).define("RecordComparison",["aq"],S);const o=e.module(P);return a.import("aq",o),a.import("op",o),a}function A(e){return e`# Waterfall chart`}function C(e){return e`### Objective
...
`}function Tt(e){return e}function Pt(e){return e`### Dataset 2`}function Ft(e){return e}function Et(e,t){return e`
