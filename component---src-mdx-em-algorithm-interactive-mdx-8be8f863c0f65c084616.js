"use strict";(self.webpackChunkrobinlinacre=self.webpackChunkrobinlinacre||[]).push([[8273],{1026:function(e,t,i){i.r(t),i.d(t,{Head:function(){return Ui},default:function(){return Qi},output_order:function(){return Hi}});var a=i(7294),n=i(7506),o=i(7825);function r(e){return e`| <h3>Friends & Family:</h3>  |   |
|---|---|
...
~~~`}function ge(e){return e()}function we(e){return e({title:"A Text Input",placeholder:"Placeholder text",description:"Note that text inputs don’t show output on the right"})}function ye(e){return e}function xe(e){return e({placeholder:"Placeholder text",description:"This input only changes value on submit",submit:"Go"})}function ke(e){return e}function je(e){return function(t={}){const{value:i,title:a,description:n,autocomplete:o="off",maxlength:r,minlength:l,pattern:s,placeholder:u,size:d,submit:c}="string"==typeof t?{value:t}:t,f=e({type:"text",title:a,description:n,submit:c,attributes:{value:i,autocomplete:o,maxlength:r,minlength:l,pattern:s,placeholder:u,size:d}});return f.output.remove(),f.input.style.fontSize="1em",f}}function Ae(e){return e`---
## Textareas

~~~js
import {textarea} from "@jashkenas/inputs"
~~~`}function $e(e){return e()}function Me(e){return e}function Ge(e){return e({title:"Your Great American Novel",placeholder:"Insert story here...",spellcheck:!0,width:"100%",rows:10,submit:"Publish"})}function De(e){return e}function Ce(e,t){return function(i={}){const{value:a="",title:n,description:o,autocomplete:r,cols:l=45,rows:s=3,width:u,height:d,maxlength:c,placeholder:f,spellcheck:m,wrap:p,submit:v}="string"==typeof i?{value:i}:i,b=e({form:t`<form><textarea style="display: block; font-size: 0.8em;" name=input>${a}</textarea></form>`,title:n,description:o,submit:v,attributes:{autocomplete:r,cols:l,rows:s,maxlength:c,placeholder:f,spellcheck:m,wrap:p}});return b.output.remove(),null!=u&&(b.input.style.width=u),null!=d&&(b.input.style.height=d),v&&(b.submit.style.margin="0"),(n||o)&&(b.input.style.margin="3px 0"),b}}function Ee(e){return e`---
## Radio Buttons
...
`}function jt(e,t){return e.markSquare({size:2,opacity:1}).data("data/zipcodes.csv").transform(e.calculate("substring(datum.zip_code, 0, 1)").as("digit")).project(e.projection("albersUsa")).encode(e.longitude().fieldQ("longitude"),e.latitude().fieldQ("latitude"),e.color().fieldN("digit")).width(t).height(Math.floor(t/1.75)).autosize({type:"fit-x",contains:"padding"}).config({view:{stroke:null}}).render()}function At(e){return e`## Interactive Seattle Weather 2012-2015
...
~~~`}function Ct(e,t){const i=e.module();return i.variable(t()).define(["md"],_t),i.variable(t()).define(["md"],gt),i.variable(t()).define(["md"],wt),i.variable(t("vl")).define("vl",["require"],yt),i.variable(t()).define(["md"],xt),i.variable(t("zip_codes")).define("zip_codes",["md"],kt),i.variable(t()).define(["vl","width"],jt),i.variable(t("interactive_weather")).define("interactive_weather",["md"],At),i.variable(t()).define(["vl","width"],$t),i.variable(t("parallel_coordinats")).define("parallel_coordinats",["md"],Mt),i.variable(t()).define(["vl","width"],Gt),i.variable(t("standalone_use")).define("standalone_use",["md"],Dt),i}function Et(e){return e`# Unsupervised probabalistic data matching using the Expectation Maximisation algorithm`}function Tt(e){return e`This notebook is an interactive implementation of the Fellegi-Sunter model of record linkage, with record linkage probabilities estimated using the Expectation Maximisation (EM) algorithm.  
