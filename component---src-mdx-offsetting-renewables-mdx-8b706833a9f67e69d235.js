"use strict";(self.webpackChunkrobinlinacre=self.webpackChunkrobinlinacre||[]).push([[8959],{3432:function(e,t,n){n.r(t),n.d(t,{Head:function(){return N},default:function(){return F},output_order:function(){return R}});var o=n(7294),r=n(7506),i=n(7825);function a(e){return e`# Magic energy usage and carbon emissions converter`}function s(e,t,n){const o=e`<input type="number" >`,r=e`
         <input name="unit_from" type="text" autocomplete="off" 
          ...
          <datalist id="options2">
              ${t.map((t=>Object.assign(e`<option>`,{value:t})))}
          </datalist>`;function a(){s.value={value:o.value,from:r.children[0].value,to:i.children[0].value},s.dispatchEvent(new CustomEvent("input"))}r.onclick=()=>{r.children[0].value="",i.children[0].value=""},i.onclick=()=>{i.children[0].value=""},r.onchange=()=>{let t=r.children[0].value,o=Object.keys(n.convert._constants_dict[t]),s=i.children[1],u=o.reduce(((e,t)=>`${e}<option value="${t}">`),""),c=e`options_list`;console.log(c.outerHTML),s.innerHTML=u,a()},o.onkeyup=a,i.onchange=a;const s=e`<p>Convert the value ${o} <br/> from ${r} <br/> into ${i}<br/></p>`;return s.value={value:"",from:"",to:""},s}function u(e,t,n){let o=""!=e.value,r=""!=e.from,i=""!=e.to;if(o&&r&&i){let o=e,r=t.convert.convert_units(o.from,o.to)*o.value;return n`${o.value} ${o.from} is ${r} ${o.to}`}return n`Please enter a value and select from and to units`}function c(e,t){return e(t.from,t.to)}function l(e,t,n){return function(o,r){function i(e){return e||""}let a=e`Conversion from \`${o}\` to \`${r}\``,s=t.convert._constants_dict[o][r].sources,u=n`<table> 
   <tr>
...
`;return n`${a} ${u}`}}function f(e){return Object.keys(e.convert._constants_dict)}function d(e){return e.convert._constants_dict.imperial_gas_units.gbp_to_generate_nuclear_hinkley_point_uk}function m(e){return e("@robinl/energy_usage@0.1.6")}function h(e,t){const n=e.module();return n.variable(t()).define(["md"],a),n.variable(t("viewof conversion")).define("viewof conversion",["html","from_options","eu"],s),n.variable(t("conversion")).define("conversion",["Generators","viewof conversion"],((e,t)=>e.input(t))),n.variable(t("converted_value")).define("converted_value",["conversion","eu","md"],u),n.variable(t()).define(["get_sources","conversion"],c),n.variable(t("get_sources")).define("get_sources",["md","eu","html"],l),n.variable(t("from_options")).define("from_options",["eu"],f),n.variable(t()).define(["eu"],d),n.variable(t("eu")).define("eu",["require"],m),n}function _(e){return e`# Carbon offsetting vs. the cost of renewable energy`}function g(e){return e`*A final version of this notebook can be viewed on my blog [here](https://www.robinlinacre.com/offsetting_renewables/).*`}function p(e,t){return e`There are a multitude of reputable sites that allow you to offset carbon emissions.
