"use strict";(self.webpackChunkrobinlinacre=self.webpackChunkrobinlinacre||[]).push([[2088],{1060:function(e,t,o){o.r(t),o.d(t,{Head:function(){return f},default:function(){return y},output_order:function(){return v}});var a=o(7294),n=o(7506),i=o(7825);function r(e){return e`# Interactive blogging with Observable Notebooks and gatsby.js`}async function*s(e,t,o){let a=0;const n="Interactive blogging with Observable Notebooks and gatsby.js";let i;for(;a<60;){await e.delay(40);let r=t`<span>${n.substr(a,1)}</span>`;r.style.color=o.interpolateViridis(a/60),r.setAttribute("value",a),r.setAttribute("ascending","ascending"),i=0==a?t`<span>${r}`:t`${i.innerHTML}${r}`,a+=1,yield t`<h1>${i}</h1>`}for(;a>=60;){await e.delay(100);let n=t`<h1>${i}</h1>`,r=n.firstChild.children;for(let e of r){let t=+e.getAttribute("value");60==t|-1==t&&e.toggleAttribute("ascending"),e.hasAttribute("ascending")?t--:t++,e.setAttribute("value",t),e.style.color=o.interpolateViridis(t/60)}a+=1,yield n}}function l(e){return e`This website contains a variety of interactive content like my [energy usage calculator](https://robinl.github.io/robinlinacre/energy-usage) which I can create easily and host for free.  In this post I explain how the it all works.
...
`}function m(e){return e("d3")}function g(e,t){const o=e.module();return o.variable(t()).define(["md"],r),o.variable(t("message")).define("message",["Promises","html","d3"],s),o.variable(t("md1")).define("md1",["md"],l),o.variable(t("md2")).define("md2",["md"],b),o.variable(t("md3")).define("md3",["md"],c),o.variable(t("md4")).define("md4",["md"],d),o.variable(t("md5")).define("md5",["md"],h),o.variable(t("md6")).define("md6",["md"],u),o.variable(t("d3")).define("d3",["require"],m),o}var p=o(5860);const f=e=>a.createElement(i.H,{frontmatter:e.pageContext.frontmatter}),v=["message","md1","md2","md3","md4","md5","md6"];function w(e){return a.createElement(p.Z,{notebook:g,cells:v})}var y=function(e){return void 0===e&&(e={}),a.createElement(n.fE,e,a.createElement(w,e))}},5860:function(e,t,o){var a=o(7294),n=o(6493);const i="mdx-container-div",r=new n.Zu,s=Object.assign({},r,{width:function(){return r.Generators.observe((e=>{let t=e(document.getElementById(i).clientWidth);function o(){let o=document.getElementById(i).clientWidth;o!==t&&e(t=o)}return window.addEventListener("resize",o),()=>window.removeEventListener("resize",o)}))}});t.Z=function(e){let{notebook:t,cells:o,customClassName:i}=e;const r=(0,a.useRef)(o.map((()=>a.createRef())));return(0,a.useEffect)((()=>{const e=new n.r_(s);return e.module(t,(e=>{const t=o.indexOf(e);if(-1!==t)return new n.lj(r.current[t].current)})),()=>e.dispose()}),[t,o]),a.createElement("div",{className:i},r.current.map(((e,t)=>a.createElement("div",{key:t,ref:e}))))}},7825:function(e,t,o){o.d(t,{H:function(){return i}});var a=o(7294),n=o(4160);const i=e=>{let{frontmatter:t}=e;const{title:o,description:i,image:r,siteUrl:s,twitterUsername:l}=(0,n.K2)("1865044719").site.siteMetadata,b={title:(null==t?void 0:t.title)||o,description:(null==t?void 0:t.description)||i,image:""+s+((null==t?void 0:t.image)||r),url:""+s+((null==t?void 0:t.pathname)||""),twitterUsername:l,...t};return a.createElement(a.Fragment,null,a.createElement("title",null,b.title),a.createElement("meta",{name:"description",content:b.description}),a.createElement("meta",{name:"image",content:b.image}))}}}]);
//# sourceMappingURL=component---src-mdx-interactive-blogging-mdx-5cffd0c620db09eeff96.js.map