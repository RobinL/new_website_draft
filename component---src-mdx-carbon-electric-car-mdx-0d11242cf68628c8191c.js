...
${i.bind(t`${s}`,a)}`}function L(e,i,t,n){return e`Carbon intensity of electricity production:  ${i.bind(t`<input type=number style='width:3rem'>`,n)} gCO2/kWh`}function V(e){return e`## Results

### Total carbon emissions
`}function $(e,i,t,n){return e`Total lifetime carbon emissions are ${i.toPrecision(3)} tonnes CO2 for the ICE car, and   ${t.toPrecision(3)} tonnes CO2 for the electric car.
