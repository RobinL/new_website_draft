...
`}function j(e,t,a,n){let r=e(t,{columns:{name:{formatter(e,t,n){let i=a`<a style='cursor:pointer'>${e}</a>`;return i.addEventListener("click",(()=>{r.value=n,r.dispatchEvent(new CustomEvent("input"))})),i}},elected:{type:"string"},approval:{formatter(e,t){let r=n.scaleLinear().domain([-2,0,2]).range(["#f4c8cf","#f8f8f8","#c8f4cb"]);return a`<td style='background:${r(e)};text-align:right;padding:2px 5px;'>${e}</td>`}}}});return r}function N(e,t){return e&&t`## ${e.name}
...
- Vertical borders
- Alternate row coloring`}function I(){return{columns:{},style:"normal",paged:25}}function A(){return e=>e}function F(e){return e`Helpers (not used in export path)`}function D(e){return e("d3@5")}function L(e){return e`Datasets`}async function q(e,t){return e.csv(await t("regional-global-daily-latest@2.csv").url())}function H(e){return e.map((e=>({Track:[e["Track Name"],e.Artist],Streams:+e.Streams})))}function B(){return[{method:"Hand",percent:58},{method:"Bus",percent:27},{method:"Post office, money order",percent:24},{method:"Direct deposit",percent:11},{method:"Money transfer services",percent:9},{method:"Cheque",percent:4},{method:"Someone else's account",percent:3}]}function z(){return["Barney","Homer","Bart","Lisa","Marge"].map(((e,t)=>({name:e,elected:1990+5*t,approval:t-2})))}function G(e){return e.csvParse('PassengerId,Survived,Pclass,Name,Sex,Age,SibSp,Parch,Ticket,Fare,Cabin,Embarked\n1,0,3,"Braund, Mr. Owen Harris",male,22,1,0,A/5 21171,7.25,,S\n2,1,1,"Cumings, Mrs. John Bradley (Florence Briggs Thayer)",female,38,1,0,PC 17599,71.2833,C85,C\n3,1,3,"Heikkinen, Miss. Laina",female,26,0,0,STON/O2. 3101282,7.925,,S\n4,1,1,"Futrelle, Mrs. Jacques Heath (Lily May Peel)",female,35,1,0,113803,53.1,C123,S\n5,0,3,"Allen, Mr. William Henry",male,35,0,0,373450,8.05,,S\n6,0,3,"Moran, Mr. James",male,,0,0,330877,8.4583,,Q\n7,0,1,"McCarthy, Mr. Timothy J",male,54,0,0,17463,51.8625,E46,S\n8,0,3,"Palsson, Master. Gosta Leonard",male,2,3,1,349909,21.075,,S').map((({Age:e,Name:t,Fare:a})=>({Name:t,Age:+e,Fare:+a})))}function J(e,t){const a=e.module();return a.variable(t()).define(["md","opinionPolls"],_),a.variable(t()).define(["md"],w),a.variable(t()).define(["table","titanicData","d3","html"],k),a.variable(t()).define(["md"],$),a.variable(t()).define(["table","spotify","html","d3"],E),a.variable(t("table")).define("table",["defaultOptions","html","th","identity"],x),a.variable(t()).define(["md"],M),a.variable(t()).define(["table","kenyaData","html","d3"],S),a.variable(t()).define(["md"],C),a.variable(t("viewof name")).define("viewof name",["table","opinionPolls","html","d3"],j),a.variable(t("name")).define("name",["Generators","viewof name"],((e,t)=>e.input(t))),a.variable(t()).define(["name","md"],N),a.variable(t("th")).define("th",["html"],T),a.variable(t("style")).define("style",O),a.variable(t()).define(["md"],P),a.variable(t("defaultOptions")).define("defaultOptions",I),a.variable(t("identity")).define("identity",A),a.variable(t()).define(["md"],F),a.variable(t("d3")).define("d3",["require"],D),a.variable(t()).define(["md"],L),a.variable(t("spotifyCharts")).define("spotifyCharts",["d3","FileAttachment"],q),a.variable(t("spotify")).define("spotify",["spotifyCharts"],H),a.variable(t("kenyaData")).define("kenyaData",B),a.variable(t("opinionPolls")).define("opinionPolls",z),a.variable(t("titanicData")).define("titanicData",["d3"],G),a}function R(e){return e`# Flight distance calculator`}function W(e){return e`*A final version of this notebook can be viewed on my blog [here](https://www.robinlinacre.com/flight_distance/).*`}function U(e,t,a){const n=e`
