"use strict";(self.webpackChunkrobinlinacre=self.webpackChunkrobinlinacre||[]).push([[3540],{4216:function(e,t,i){i.r(t),i.d(t,{Head:function(){return Kt},default:function(){return ii},output_order:function(){return ei}});var n=i(7294),o=i(7506),a=i(7825);function r(e){return e`| <h3>Friends & Family:</h3>  |   |
|---|---|
...
~~~`}function we(e){return e()}function ye(e){return e({title:"A Text Input",placeholder:"Placeholder text",description:"Note that text inputs don’t show output on the right"})}function xe(e){return e}function ke(e){return e({placeholder:"Placeholder text",description:"This input only changes value on submit",submit:"Go"})}function Se(e){return e}function _e(e){return function(t={}){const{value:i,title:n,description:o,autocomplete:a="off",maxlength:r,minlength:s,pattern:l,placeholder:u,size:d,submit:p}="string"==typeof t?{value:t}:t,f=e({type:"text",title:n,description:o,submit:p,attributes:{value:i,autocomplete:a,maxlength:r,minlength:s,pattern:l,placeholder:u,size:d}});return f.output.remove(),f.input.style.fontSize="1em",f}}function $e(e){return e`---
## Textareas
